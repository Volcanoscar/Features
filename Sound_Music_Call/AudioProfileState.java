...
public class AudioProfileState {
    ...
    public Uri mMusicStream; //add MUSIC volume
    public int mMusicVolume; //add MUSIC volume
    public Uri mVoiceCallStream; //add VOICE CALL volume
    public int mVoiceCallVolume; //add VOICE CALL volume
    ...
    public static class Builder {
        ...
        //chb add for LFZSF-12 begin
        private Uri mMusicStream = AudioProfileManager.DEFAULT_RINGER_STREAM_URI;
        private int mMusicVolume = 8; //add MUSIC volume
        private Uri mVoiceCallStream = AudioProfileManager.DEFAULT_RINGER_STREAM_URI;
        private int mVoiceCallVolume= 0;//add VOICE CALL volume
        //chb add for LFZSF-12 end
    ...
    private AudioProfileState(Builder builder) {
        ...
        //chb add for LFZSF-12 MUSIC volume and Voice call volume begin
        mMusicStream = builder.mMusicStream;
        mMusicVolume = builder.mMusicVolume;
        mVoiceCallStream = builder.mVoiceCallStream;
        mVoiceCallVolume = builder.mVoiceCallVolume;
        //chb add for LFZSF-12 end
    }
