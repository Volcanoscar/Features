...
public class Editprofile extends SettingsPreferenceFragment {
    ...
    public static final String KEY_MUSIC_VOLUME = "music_volume";//chb add for LFZSF-12  MUSIC volume
    public static final String KEY_VOICE_CALL_VOLUME = "voice_call_volume"; //chb add for LFZSF-12  VOICE CALL volume
    ...
    private void initVolume(PreferenceScreen parent) {
        ...
        initVolumePreference(KEY_MUSIC_VOLUME, AudioManager.STREAM_MUSIC);//chb add for LFZSF-12  MUSIC volume
        initVolumePreference(KEY_VOICE_CALL_VOLUME, AudioManager.STREAM_VOICE_CALL); //chb add for LFZSF-12 VOICE CALL volume
        if (mVoiceCapable) {
