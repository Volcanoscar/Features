...
public abstract class PhotoPage extends ActivityState implements
    ...
    public boolean canDisplayBottomControls() {
         ...
         */
        boolean visible = mIsActive && !mPhotoView.canUndo() && mCanDisplayBottomControls;
        return visible;
        /// @}
    }
    ...
    private void launchPhotoEditor() {
        ...
        intent.setDataAndType(current.getContentUri(), current.getMimeType())
                .setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
        */
		// kth modify for POPLUSVNMS-75 20151222 start
        /* old value: 
		...
		// kth modify for POPLUSVNMS-75 20151222 end
        /// @}
...
/// @}
    ...
    private boolean mCanDisplayBottomControls = true;
    ...
    private LayerManager.IBackwardContoller mBackwardContollerForLayer =
        ...
        @Override
        public void refreshBottomControls(boolean canDisplayBottomControls) {
            mCanDisplayBottomControls = canDisplayBottomControls;
            Log.d(TAG, " canDisplayBottomControls = "+canDisplayBottomControls);
            refreshBottomControlsWhenReady();
        }

        @Override
        public void startActivityForResult(Intent intent, int type) {
        }
    ...
    private void setRefocusCurrentPhotoByIntent(Intent intent) {
        Log.d(TAG, "<setRefocusCurrentPhotoByIntent> intent:" + intent);
        if (intent == null) return;
