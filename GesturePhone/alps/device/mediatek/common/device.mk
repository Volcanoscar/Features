...
PRODUCT_PROPERTY_OVERRIDES += ro.mediatek.version.branch=L1.MP10
...
ifneq ($(MTK_AUDIO_TUNING_TOOL_VERSION),)
  ifneq ($(strip $(MTK_AUDIO_TUNING_TOOL_VERSION)),V1)
    ...
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/audio_param/Speech_AudioParam.xml:system/etc/audio_param/Speech_AudioParam.xml
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/audio_param/Speech_ParamUnitDesc.xml:system/etc/audio_param/Speech_ParamUnitDesc.xml
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/audio_param/SpeechDMNR_AudioParam.xml:system/etc/audio_param/SpeechDMNR_AudioParam.xml
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/audio_param/SpeechDMNR_ParamUnitDesc.xml:system/etc/audio_param/SpeechDMNR_ParamUnitDesc.xml
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/audio_param/SpeechGeneral_AudioParam.xml:system/etc/audio_param/SpeechGeneral_AudioParam.xml
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/audio_param/SpeechGeneral_ParamUnitDesc.xml:system/etc/audio_param/SpeechGeneral_ParamUnitDesc.xml
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/audio_param/Playback_AudioParam.xml:system/etc/audio_param/Playback_AudioParam.xml
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/audio_param/Playback_ParamUnitDesc.xml:system/etc/audio_param/Playback_ParamUnitDesc.xml
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/audio_param/Record_AudioParam.xml:system/etc/audio_param/Record_AudioParam.xml
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/audio_param/Record_ParamUnitDesc.xml:system/etc/audio_param/Record_ParamUnitDesc.xml
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/audio_param/VoIP_AudioParam.xml:system/etc/audio_param/VoIP_AudioParam.xml
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/audio_param/VoIP_ParamUnitDesc.xml:system/etc/audio_param/VoIP_ParamUnitDesc.xml

#    include vendor/mediatek/proprietary/external/AudioParamParser/mk/GenerateFeatureOptionsXml.mk
#    PRODUCT_COPY_FILES += $(LOCAL_PATH)/FeatureOptions.xml:system/etc/audio_param/FeatureOptions.xml
  endif
endif
...
#liuhao added for one click removal 20151130
ifeq ($(strip $(MLT_ONE_CLICK_REMOVAL)), yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.mlt_one_click_removal=1
endif
...
#hgx add for MOPLUES-22 2015-07-09
ifeq ($(strip $(SHAKE_OPEN_APPLICATION)), yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.shake_open_app_support=1
endif

#aoran add for LFZSF-2
ifeq ($(strip $(SMART_GESTURE_PHONE)), yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.smart_gesture_phone_support=1
endif