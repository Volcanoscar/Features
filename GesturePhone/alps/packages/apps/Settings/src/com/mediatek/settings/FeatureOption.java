...
public class FeatureOption {
    ...
    public static final boolean SHAKE_OPEN_APPLICITION = getValue("ro.shake_open_app_support");

    //aoran add for LFZSF-2
    public static final boolean SMART_GESTURE_PHONE_SUPPORT = getValue("ro.smart_gesture_phone_support");
