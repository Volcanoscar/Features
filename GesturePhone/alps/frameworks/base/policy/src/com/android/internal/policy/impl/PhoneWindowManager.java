...
import android.gxFP.FingerprintManager; //cqf add MOPLUES-2 20151006
...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private FingerprintManager mFingerprintManager; //cqf add MOPLUES-2 20151006
    ...
    public void init(Context context, IWindowManager windowManager,
	 ...
	 //cqf add MOPLUES-2 20151006 start
	 SystemProperties.set("sys.goodix.fpdaemon", "1");
        //cqf add MOPLUES-2 20151006 end
        //aoran add LFZSF-2,start.
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_VOLUME_MUTE: {
                ...
                boolean bQuickLaunchCameraOn = 1==Settings.Secure.getInt(cr,
                            Settings.System.DEF_SMART_ACTION, Settings.Secure.DEF_QUICK_LAUNCH_CAMERA, 0) ;
                boolean bQuickLaunchPhoneOn = 1==Settings.Secure.getInt(cr,
                            Settings.System.DEF_SMART_ACTION, Settings.Secure.DEF_QUICK_LAUNCH_PHONE, 0) ;
	     ...
	     //cqf add MOPLUES-2 20151006 start		            
            case  KeyEvent.KEYCODE_MOVE_HOME/*KEYCODE_F10*/:{
                if(down) {
			              Log.d(TAG, "cqf verify interceptKeyBeforeQueueing keyCode="+keyCode);
