...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        public static final String BREATHLED = "breathled"; //cqf add MOPLUES-4 20151006

	 public static final String ENABLE_FP_LOCKSCREEN = "enable_fp_lockscreen"; //cqf add MOPLUES-2 20151020
    ...
    public static final class Secure extends NameValueTable {
       ...
       /** MTK ADD END. @} */
        ...
        //aoran add "double click" for LFZSF-2,start.
        public static final String DEF_FLIP_TO_SILENCE = "def_flip_to_silence";

        public static final String DEF_FLIP_TO_SPEAKER = "def_flip_to_speaker";

        public static final String DEF_FLIP_TO_SNOOZE_ALARM = "def_flip_to_snooze_alarm";

        public static final String DEF_DECREASE_RING_ON_MOVE = "def_decrease_ring_on_move";

        public static final String DEF_QUICK_LAUNCH_CAMERA = "def_quick_launch_camera";

        public static final String DEF_QUICK_LAUNCH_PHONE = "def_quick_launch_phone";
        //aoran add "double click" for LFZSF-2,end.
    }
