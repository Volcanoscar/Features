...
public class NotificationPanelView extends PanelView implements
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
           ...
           // LogUtils.v(LOGTAG, "Received broadcast: %s", action);
                ...
                switch (action) {
                    case PHONE_QUICK_CAMERA_ACTION:
                        mSecureCameraLaunchManager.startSecureCameraLaunch();
                        break;
                    case PHONE_QUICK_PHONE_ACTION:
    ...
    protected void onFinishInflate() {
        ...
        filter.addAction(PHONE_QUICK_CAMERA_ACTION);
        filter.addAction(PHONE_QUICK_PHONE_ACTION);
        getContext().registerReceiver(mReceiver, filter,null,null);
        //aoran add LFZSF-2,end.
    }
