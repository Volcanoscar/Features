...
#wangmeng add 20150907 for GetHardInfo
PRODUCT_PACKAGES += GetHardInfo
#laiyang add for FloatMultiTask
PRODUCT_PACKAGES += FloatMultiTask
#hgx add for FactoryTest 
PRODUCT_PACKAGES += FactoryTest
PRODUCT_PACKAGES += libbacklightJni
PRODUCT_PACKAGES += libBatteryJni
PRODUCT_PACKAGES += libmacAddrJni
...
#liuhao for BeautyCamera 20150608
ifeq ($(strip $(GANGYUN_CAMERA_BEAUTY)),yes)
PRODUCT_PACKAGES += BeautyCamera
endif
