   ...
   public Context getSettingContext(){
    ...
    public void setDefaultGesture(){  
		...
		//M	  
              ...
              if(appName.isEmpty()){	
                  saveSelectedAPP(ctx, GESTURES_SETTINGS_M, "com.android.email", "com.android.email.activity.Welcome", "Email");
              }  
		...
		//E	  
              ...
              if(appName.isEmpty()){	  	
                  ...
                  saveSelectedAPP(ctx, GESTURES_SETTINGS_E, "com.android.chrome", "com.google.android.apps.chrome.Main", "Chrome");
              }   
	      ...
	      pre = ctx.getSharedPreferences(GESTURES_SETTINGS_C, /*MODE_WORLD_READABLE*/1);
              appName = pre.getString("app_name", "");  			  
              if(appName.isEmpty()){	          
                  saveSelectedAPP(ctx, GESTURES_SETTINGS_C, "com.android.dialer", "com.android.dialer.DialtactsActivity", "Phone");
              }
