...
public class LauncherAppState implements DeviceProfile.DeviceProfileCallbacks {
    ...
    private LauncherAppState() {
        ...
        //tdj
        final String wallPaperChooserProcessName = "com.android.launcher3:wallpaper_chooser";
		...
		for (ActivityManager.RunningAppProcessInfo info : list){
			if(pid == info.pid){
				if (!info.processName.equals(wallPaperChooserProcessName)){
					IntentFilter switchTheme = new IntentFilter();
					switchTheme.addAction(Theme.INTENT_THEME_CHOOSER_ACTIVITY_SWITCH_THEME);
					sContext.registerReceiver(mModel,switchTheme);
                    LauncherLog.e(TAG,"regiseter theme switch broadcast recevier");
				}
			}
		}
        //tdj
