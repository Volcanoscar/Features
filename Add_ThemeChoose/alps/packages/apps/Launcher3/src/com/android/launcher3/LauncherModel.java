...
public class LauncherModel extends BroadcastReceiver
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Intent.ACTION_LOCALE_CHANGED.equals(action)) {
            ...
            //tdj
        } else if (Theme.INTENT_THEME_CHOOSER_ACTIVITY_SWITCH_THEME.equals(action)){
            String iconsConfig= intent.getStringExtra(Theme.ICON_CONFIG);
            if(null == iconsConfig){
                return;
            }
            ...
            editor.putString(Theme.ICON_CONFIG,iconsConfig);
            editor.apply();
            mIconCache.flush();
            forceReload();
        }
