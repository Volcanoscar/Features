...
//                }
            ...
            case R.id.FMR_Freq_tune:
                ...
                try {
                    ...
                    if (!FmUtils.isValidStation(station)) {
                        Toast.makeText(FmEmActivity.this, "Please input 87.5 ~ 108.0.", Toast.LENGTH_SHORT).show();
                        mEditFreq.setText(FmUtils.formatStation(mCurrentStation));
                        return;
                    }
                } catch (NumberFormatException e) {
                    Toast.makeText(FmEmActivity.this, "bad float format.", Toast.LENGTH_SHORT).show();
                    mEditFreq.setText(FmUtils.formatStation(mCurrentStation));
                    return;
                }
            ...
            case R.id.FMR_EM_RSSI_THRESHOLD_OK:
                ...
                if (isRssiOk) {
                    Toast.makeText(FmEmActivity.this, "Rssi Threshold set OK.", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(FmEmActivity.this, "Rssi Threshold set fail.", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.FMR_EM_DESENSE_RSSI_OK:
                ...
                if (isDeRssiOk) {
                    Toast.makeText(FmEmActivity.this, "Desense Rssi Threshold set OK.", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(FmEmActivity.this, "Desense Rssi Threshold set fail.", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.FMR_EM_MUTE_GAIN_OK:
                ...
                if (isMuteOk) {
                    Toast.makeText(FmEmActivity.this, "Software mute gain set OK.", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(FmEmActivity.this, "Software mute gain set fail.", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.FMR_EM_CMD_OK:
                ...
                if (cmds == null) {
                    Toast.makeText(FmEmActivity.this, "cmd execute fail.", Toast.LENGTH_SHORT).show();
...
//        ComponentName cn = startService(new Intent(FmEmActivity.this, FmService.class));
//        if (null == cn) {
//            Log.e(TAG, "Error: Cannot start FM service");
//        } else {
//            Log.d(TAG, "Start FM service successfully.");
//            mIsServiceStarted = true;
        /*mIsServiceBinded = bindService(new Intent(FmEmActivity.this, FmService.class), mServiceConnection,
