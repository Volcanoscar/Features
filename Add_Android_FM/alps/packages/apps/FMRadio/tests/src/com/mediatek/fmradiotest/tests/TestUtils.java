...
public class TestUtils {
   ...
   public static Object getVariableFromActivity(Activity activity, String variable) {
       ...
       Object value = null;
       try {
           field = FmMainActivity.class.getDeclaredField(variable);
   ...
   // get variable from activity.
   public static Object getVariableFromFavActivity(Activity activity, String variable) {
       Field field = null;
       Object value = null;
       try {
           field = FmFavoriteActivity.class.getDeclaredField(variable);
           field.setAccessible(true);
           value = field.get(activity);
       } catch (SecurityException e) {
           e.printStackTrace();
