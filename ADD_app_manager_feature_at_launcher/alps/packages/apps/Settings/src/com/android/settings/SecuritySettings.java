...
//cqf add LFZS-21 20150604 start
import android.view.WindowManagerGlobal;
import android.os.RemoteException;
import android.view.IWindowManager;
//cqf add LFZS-21 20150604 end
...
//shuyong 20140913 app manager begin
import android.os.SystemProperties;
//shuyong 20140913 app manager end
...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    IWindowManager mWindowManagerService;  //cqf add LFZS-21 20150604 
    ...
    public void onCreate(Bundle savedInstanceState) {
	 ...
	 mWindowManagerService = WindowManagerGlobal.getWindowManagerService();   //cqf add LFZS-21 20150604 
    }
	...
	if(SystemProperties.get("ro.mlt.MALATA_APP_MANAGER").equals("1")){
		addPreferencesFromResource(R.xml.security_settings_lock_app);
	}
	//shuyong 20140913 app manager end
        ...
        /*liuhao add for visitor mode 20141125 begin*/
		if (FeatureOption.MLT_VISITOR_MODE) {
			if ((Settings.Global.getInt(getActivity().getContentResolver(),
					"malata_visitor_mode", 0) != 0)
					&& (Settings.Global.getInt(getActivity()
							.getContentResolver(), "malata_visitor_mode_in", 0) == 1)) {
	            if (securityCategory != null) {
	            	securityCategory.removePreference(root.findPreference(KEY_UNLOCK_SET_OR_CHANGE));
	            }
			} else {
				addPreferencesFromResource(R.xml.malata_visitor_mode);
			}

		}
        /*liuhao add for visitor mode 20141125 end*/
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        //shuyong 20140913 app manager begin
        if("lock_app_screen".equals(key)) {
            Intent newIntent = new Intent();
            newIntent.setClassName("com.android.launcher3", "com.android.launcher3.LoginLockedAppActivity");
