...
public class MessagingNotification {
	...
	//shuyong app manager begin
	private static Context mContext;
	//shuyong app manager end
    ...
    private static final class NotificationInfo {
        ...
        public NotificationInfo(boolean isSms,
            ...
            /// @}
             ...
             // shuyong 20141015 begin
            if(MessagingNotification.mContext.getSharedPreferences("com.android.mms_preferences", 4).getInt("ismmschoosed", 0) == 1)
            {
                mMessage = "***********";
                mTitle = "***********";
            }else{
...
//                | Intent.FLAG_ACTIVITY_CLEAR_TOP);
    ...
    private static void updateNotification(
        ...
        // shuyong 20141015 begin
        Log.d("zhangle", (new StringBuilder()).append("nofification.tickerText=").append(notification.tickerText).toString());
        int ismmschoosed = context.getSharedPreferences("com.android.mms_preferences", 4).getInt("ismmschoosed", 0);
        if(ismmschoosed == 1)
        {
            notification.tickerText = "**************";
            Intent intent2 = new Intent();
            intent2.setComponent(new ComponentName("com.android.launcher3", "com.android.launcher3.LoginLockedAppActivity"));
            intent2.putExtra("PackageName", "com.android.mms");
            intent2.putExtra("ClassName", "com.android.mms.ui.BootActivity");
            intent2.putExtra("isEntryApp", true);
            PendingIntent pendingintent = PendingIntent.getActivity(context, 0, intent2, 0x8000000);
