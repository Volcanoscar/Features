...
public class ContactListItemView extends ViewGroup
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mPhotoPosition == PhotoPosition.LEFT) {
            ...
            if (photoView != null) {
                ...
                photoView.layout(
                        leftBound+2,//zhaoxy modify 141118 +2 for LFZS-16 blade view
                        photoTop,
    ...
    public TextView getLabelView() {
        if (mLabelView == null) {
            ...
            int paddingRight = getResources().getDimensionPixelSize(R.dimen.blade_width);
            mLabelView.setPadding(0, 0, paddingRight, 0);
