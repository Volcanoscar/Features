...
# cqf modify MOPLUES-37 20151209
BOOT_LOGO = fhd
BUILD_CTS = yes
BUILD_KERNEL = yes
BUILD_LK = yes
...
# wangmeng modify 20151021
CUSTOM_HAL_CAM_CAL = imx230xxsunnyotp
CUSTOM_HAL_COMBO = mt6755
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
# wangmeng modify 20151021
CUSTOM_HAL_IMGSENSOR = imx230_mipi_raw ov8858_mipi_raw
CUSTOM_HAL_LENS = imx230xxsunnyaf dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
# wangmeng modify 20151021
CUSTOM_HAL_MAIN_BACKUP_LENS =
CUSTOM_HAL_MAIN_IMGSENSOR = imx230_mipi_raw
CUSTOM_HAL_MAIN_LENS = imx230xxsunnyaf
...
# wangmeng modify 20151021
CUSTOM_KERNEL_CAM_CAL = imx230xxsunnyotp
...
# wangmeng modify 20151021
CUSTOM_KERNEL_IMGSENSOR = imx230_mipi_raw ov8858_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
# wangmeng modify 20151021
CUSTOM_KERNEL_LENS = imx230xxsunnyaf dummy_lens
...
CUSTOM_KERNEL_MAIN_LENS = imx230xxsunnyaf
...
CUSTOM_MODEM = mlt6755_65_l_lwctg
...
# cqf modify MOPLUES-37 20151209
MTK_AUDIO_TUNING_TOOL_VERSION = V2.1
...
#chb close Android Beam for POPLUSVNMS-37 20151221 old:yes  
...
MTK_BUILD_VERNO = ALPS.L1.MP10.V1_MLT6755.65U.L_P3
MTK_BWC_SUPPORT = yes
MTK_C2K_SUPPORT = no
...
# cqf modify MOPLUES-40 20151209
...
MTK_ION_SUPPORT = yes
#chb close quick boot 2015-12-11  old :yes
MTK_IPOH_SUPPORT = no
...
#chb close NFC feature for POPLUSVNMS-37 20151221 begin
MTK_NFC_ADDON_SUPPORT = no
MTK_NFC_GSMA_SUPPORT = no
MTK_NFC_HCE_SUPPORT = no
MTK_NFC_MT6605 = no
MTK_NFC_OMAAC_SUPPORT = no
MTK_NFC_OMAAC_VER = no
MTK_NFC_SE_NUM = 3
MTK_NFC_SUPPORT = no
#rsk add for nfc settings on 20151211
MTK_NFC_APP_SUPPORT = no
#rsk add for nfc settings on 20151211
MTK_NFC_OMAAC_GEMALTO = no
#chb close NFC feature for POPLUSVNMS-37 20151221 end
...
MTK_WFD_SUPPORT = yes
# chb close  NFC feature for  POPLUSVNMS-37 20151221 old:yes
...
#CREATE_PROJECT_INFO=20151205183944
# cqf add for MOPLUES-11 20151105 for internal version 
MALATA_QUERY_INTERNAL_VERSION = M1_PLUS_MT6735_65U_L1_V1.0
MALATA_QUERY_EXTERNAL_VERSION = mobiistar_PRIME_X_Max_20151216_v1.01

#gmobi fota cqf add POPLUSVNMS-2  20151223
ROCK_GOTA_SUPPORT=yes


#chb add for  POPLUSVNMS-29 20151222
# yes: wakeup screen  when receive MMS
RECEIVE_MMS_WAKE_UP_PHONE = yes
