...
#chb add for  POPLUSVNMS-29 20151222
# wakeup screen  when receive MMS
ifeq ($(strip $(RECEIVE_MMS_WAKE_UP_PHONE)), yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.receive_mms_wakeup_support=1
endif
