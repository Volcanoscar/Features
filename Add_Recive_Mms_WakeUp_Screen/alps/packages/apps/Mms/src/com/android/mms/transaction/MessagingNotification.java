...
public class MessagingNotification {
    ...
    private static IpMessagingNotification mIpMessagingNotification;
    ...
    public static void blockingUpdateNewMessageIndicator(Context context, long newMsgThreadId,
        ...
        if (!isContinuousComming && newMsgThreadId != THREAD_NONE) {
            cancelNotification(context, NOTIFICATION_ID);
        }
    ...
    private static final int addSmsNotificationInfos(
        ...
        try {
            while (cursor.moveToNext()) {
                ...
                // add for ipmessage
                String msgContent = mIpMessagingNotification.onNewIpMsgContent(msgId, cursor);
                if (msgContent!=null) {
                	message = msgContent;
                }
...
//                | Intent.FLAG_ACTIVITY_CLEAR_TOP);
    ...
    private static void updateNotification(
        ...
        if (isNew) {
            ...
            //chb add for POPLUSVNMS-29 20151222 begin
            // Wake up the screen when receiving SMS (chb add)
            else if(FeatureOption.RECEIVE_MMS_WAKEUP_PHONE){
                PowerManager powerManager = (PowerManager) (context.getSystemService(Context.POWER_SERVICE));
                PowerManager.WakeLock wakeLock = null;
                wakeLock = powerManager.newWakeLock(PowerManager.FULL_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP | PowerManager.ON_AFTER_RELEASE, "MMS_wake_lock");
                long wakeUpTime = 0;
                try {
            ...
            //chb add for POPLUSVNMS-29 20151222 end
            /// @}
        }  
        /// @}
    }
