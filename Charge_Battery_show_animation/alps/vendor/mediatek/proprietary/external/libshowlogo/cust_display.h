...
//yutianliang add VFOZBENQ-21 begin
#define CHARGING_BETTERY_INVALID_NOBATTERY_INDEX   39
#define CHARGING_BETTERY_INVALID_CHARGING_INDEX   40
#define CHARGING_BETTERY_TOO_COLD_INDEX   41
#define CHARGING_BETTERY_TOO_HOT_INDEX   42 
//yutianliang add VFOZBENQ-21 end
	...
	#define NUMBER_TOP                   (290) //yutianliang modify for VFOZBENQ-85 old:386
	#define NUMBER_RIGHT                 (335)
	#define NUMBER_BOTTOM                (354) //yutianliang modify for VFOZBENQ-85 old:450

	// %  rectangle
	#define PERCENT_LEFT                 (380) // percent number_left + 2*number_width
	#define PERCENT_TOP                  (290) //yutianliang modify for VFOZBENQ-85 old:386
	#define PERCENT_RIGHT                (437)
	#define PERCENT_BOTTOM               (354) //yutianliang modify for VFOZBENQ-85 old:450
