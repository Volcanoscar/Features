...
import com.malata.superclean.circularprogressbar.CircularProgressBarUtils;
import com.malata.superclean.R.color;
...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private CircularProgressDrawable(int[] colors, float borderWidth, float sweepSpeed, float rotationSpeed, int minSweepAngle, int maxSweepAngle, CircularProgressDrawable.Style style, Interpolator angleInterpolator, Interpolator sweepInterpolator) {
        ...
        this.mPaint.setStrokeCap(style == CircularProgressDrawable.Style.ROUNDED?Cap.ROUND:Cap.BUTT);
    ...
    private void setupAnimations() {
        ...
        this.mSweepAppearingAnimator.addListener(new AnimatorListener() {
        ...
        this.mSweepDisappearingAnimator.addListener(new AnimatorListener() {
            boolean cancelled;
        ...
        this.mEndAnimator.addListener(new AnimatorListener() {
    ...
    public static class Builder {
        ...
        private void initValues(Context context) {
            this.mStrokeWidth = context.getResources().getDimension(dimen.cpb_default_stroke_width);
            this.mSweepSpeed = 1.0F;
            this.mRotationSpeed = 1.0F;
            this.mColors = new int[]{context.getResources().getColor(color.cpb_default_color)};
            this.mMinSweepAngle = context.getResources().getInteger(integer.cpb_default_min_sweep_angle);
            this.mMaxSweepAngle = context.getResources().getInteger(integer.cpb_default_max_sweep_angle);
