package com.malata.superclean.views.circleprogress;
...
/**
 * Created by xuxiantao on 2015/8/29.
 */
public class ArcProgress extends View {
    ...
    private final float default_suffix_text_padding;
    private final float default_stroke_width;
    private final int default_max = 100;
    private final int default_finished_color = Color.WHITE;
    //private final int default_unfinished_color = Color.rgb(72, 106, 176);
    private final int default_unfinished_color = Color.rgb(56, 142, 60);
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_bottom_text_size = DensityUtils.sp2px(getContext(), 10);
        min_size = DensityUtils.dp2px(getContext(), 100);
        default_suffix_text = "%";
        default_suffix_text_size = DensityUtils.sp2px(getContext(), 15);
        default_suffix_text_padding = DensityUtils.dp2px(getContext(), 4);
        default_stroke_width = DensityUtils.dp2px(getContext(), 4);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        suffixTextPadding = attributes.getDimension(R.styleable.ArcProgress_arc_suffix_text_padding, default_suffix_text_padding);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        if(state instanceof  Bundle) {
            ...
            suffixText = bundle.getString(INSTANCE_SUFFIX_TEXT);
            initPainters();
