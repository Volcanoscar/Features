...
import com.malata.superclean.adapter.ClearMemoryAdapter;
import com.malata.superclean.base.BaseSwipeBackActivity;
import com.malata.superclean.bean.AppProcessInfo;
import com.malata.superclean.model.StorageSize;
...
import com.malata.superclean.views.textcounter.CounterView;
import com.malata.superclean.views.textcounter.formatters.DecimalFormatter;
import com.malata.superclean.views.waveview.WaveView;
...
/**
 * Created by xuxiantao on 2015/10/20.
 */
public class MemoryCleanActivity extends BaseSwipeBackActivity implements OnDismissCallback, CoreService.OnPeocessActionListener {
    ...
    public void onClickClear() {
        ...
        T.showLong(mContext, getString(R.string.all_clean) + StorageUtil.convertStorage(killAppmemory) + getString(R.string.mermory));
        if(Allmemory > 0) {
            refeshTextCounter();
            /*StorageSize mStorageSize = StorageUtil.convertStorageSize(Allmemory);
            textCounter.setStartValue(0f);
