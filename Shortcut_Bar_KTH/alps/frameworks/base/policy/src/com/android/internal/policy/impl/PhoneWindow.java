...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    private final static String TAG_TEST = "PhoneWindow_kth";
    ShortcutDialog shortcutDialog;
    Handler mhomeHandler = new Handler();
    private final static String HOME_DOWN_ACTION = "android.intent.action.HOME_DOWN_ACTION";
    private final static String UPDATE_SHORTCUT_ACTION = "android.intent.action.UPDATE_SHORTCUT_ACTION";
    private Context mContext;
    Intent shortcutintent = new Intent();
    static int SHORTCUT_INFO = 0;// the info that if the shortcut bar is showing
    private static int mX = 0;// the coordinates when action down in response area, used for detemining whether a gesture is within the preset.
    private static int mY = 0;
    private static int display_x = 0;//the display of screen
    private static int display_y = 0;
    private int area_y_min = 1240;//the response area of action down for shortcut bar
    private int area_y_max = 1280;
    ...
    public PhoneWindow(Context context) {
        ...
        /// @}
        // kth add for LFZSF-10  shortcut bar test 20150820 start
        ...
        if(windowService != null){
            ...
            Log.i(TAG_TEST,"PhoneWindow display x--" + display_x+"   y--"+display_y);
        }
        if(display_y != 0){
            area_y_max = display_y;
            area_y_min = display_y - 30;
        }
        // kth add for LFZSF-10  shortcut bar test 20150820 start
    }
    ...
    private final class DecorView extends FrameLayout implements RootViewSurfaceTaker {
        ...
        public boolean onInterceptTouchEvent(MotionEvent event) {
            ...
            // kth add for LFZSF-10  shortcut bar 20150820 start
            int x1 = (int)event.getX();
            int y1 = (int)event.getY();
            if (action == MotionEvent.ACTION_DOWN) {
                int y = (int)event.getY();
                int x = (int)event.getX();
                if(y>area_y_min&&y<area_y_max){
                    SHORTCUT_INFO = 1;
                    mX=x;
                    mY=y;
                }
            ...
            // kth add for LFZSF-10  shortcut bar 20150820 end
