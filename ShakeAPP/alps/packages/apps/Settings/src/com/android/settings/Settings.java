...
public class Settings extends SettingsActivity {
    ...
    */
	...
	public static class ShakePreferenceFragmentActivity extends SettingsActivity { /* empty */ }//hgx add for shake open apk 20150801
    ...
    /**@}*/
	/** laiyang add for FloatMultiTask 20150724 start */
	public static class FloatMultiTaskActivity extends SettingsActivity {
		 @Override
        public boolean isValidFragment(String className) {
            if (MultiTaskSettings.class.getName().equals(className)) {
                return true;
            }
            return super.isValidFragment(className);
        }
	}
	/** laiyang add for FloatMultiTask 20150724 end */
}
