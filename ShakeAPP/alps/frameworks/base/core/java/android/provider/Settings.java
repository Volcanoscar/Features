...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
	 ...
	 //caoqiaofeng add MTSFEFL-14 20150323 end
         ...
         * {@hide}
         */
        public static final String DEF_SMART_ACTION = "def_smart_action";
        //aoran add "double click" for LFZSF-2,end.
	 
        /**
         * {@hide}
         */
 	    public static final String HALL = "hall";//zhaoxy add 140818 smartcover LFZS-8
           /**
         * {@hide}
         */
	    public static final String ANSWER_CALL_COVER_OPEN = "answer_call_cover_open";//zhaoxy add 141028 smartcover LFZS-8


        public static final String POWERSAVING = "power_saving";   //for power saving shuyong 20141124
        /**
        ...
        /**
         * Whether the sliding out of the shortcut baris enabled. The value is
         * boolean (1 or 0).
         */
        public static final String PULLUP_ENABLED = "pullup_enabled";
    ...
    public static final class Secure extends NameValueTable {
        ...
        public static int getInt(ContentResolver cr, String name2, String name, int def) {
            if(System.getInt(cr,name2,def) == 0){
                return 0;
            }
            return getIntForUser(cr, name, def, UserHandle.myUserId());
        }
        ...
        /**
        *  @hide
        *  tiandajiao add for festival wallpaper 20150713
        *  setting that festival wallpaper is checked
        */
        public static final String ACCESSIBILITY_FESTIVAL_WALLPAPER_ENABLED = "accessiblity_fetival_wallpaper_enabled";
         ...
         * Setting that shake open application is enabled.
		 * @hide
         */
        public static final String ACCESSIBILITY_SHAKE_ENABLED =
                "accessibility_shake_enabled";		
        ...
        /**
         * kth add  LFZSF-10 at 2015-8-15 for shortcut bar test.
         * Setting that specifies whether sliding out shortcut bar is enabled.
         */
        public static final String ACCESSIBILITY_DISPLAY_PULLUP_ENABLED =
                "accessibility_display_pullup_enabled";
        ...
        /**
         * turn on/off the battery percentage show in status bar  caoqiaofeng add MTSFEFL-111 20150424
         * @hide
         */
	   ...
	   //aoran add "double click" for LFZSF-2,start.
	   public static final String DEF_FLIP_TO_SILENCE =
			   "def_flip_to_silence";
	   
	   public static final String DEF_FLIP_TO_SPEAKER =
			   "def_flip_to_speaker";
	   
	   public static final String DEF_FLIP_TO_SNOOZE_ALARM =
			   "def_flip_to_snooze_alarm";
	   
	   public static final String DEF_DECREASE_RING_ON_MOVE =
			   "def_decrease_ring_on_move";
	   
	   public static final String DEF_QUICK_LAUNCH_CAMERA =
			   "def_quick_launch_camera";
	   
	   public static final String DEF_QUICK_LAUNCH_PHONE =
			   "def_quick_launch_phone";
	   //aoran add "double click" for LFZSF-2,end.
    }
    ...
    public static final class Global extends NameValueTable {
      ...
      public static final String RNS_WIFI_ROVE_OUT_RSSI = "rns_wifi_rove_out_rssi";
		...
		/**
		 * kth add  LFZSF-10  at 2015-8-15 for shortcut bar test.
		 * Setting the last audioprofile for restore state when double click the meeting-profile.
		 * 0 = MTK_AUDIOPROFILE_GENEEAL
		 * 1 = MTK_AUDIOPROFILE_SILENT
		 * 2 = MTK_AUDIOPROFILE_MEETING
		 * 3 = MTK_AUDIOPROFILE_OUTDOOR
		 */
		public static final String AUDIOPROFILE_LAST_STATE = "audioprofile_last_state";
		
		public static final String AUDIOPROFILE_NOW_STATE = "audioprofile_now_state";
    }
