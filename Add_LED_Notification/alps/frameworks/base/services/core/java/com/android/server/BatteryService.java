...
public final class BatteryService extends SystemService {
    ...
    private final class Led {
        ...
        public void updateLightsLocked() {
            ...
            boolean charingStatus = android.provider.Settings.System.getInt(mContext.getContentResolver(), Settings.System.CHARGING_REMIND_STATUS, -1) > 0?true:false;
            boolean lowPowerStatus = android.provider.Settings.System.getInt(mContext.getContentResolver(), Settings.System.LOW_POWER_REMIND_STATUS, -1) > 0?true:false;
            ...
            if ((level < mLowBatteryWarningLevel) && lowPowerStatus) {  //caoqiaofeng modify SFZT-148 20141106 (&& lowPowerStatus)
                if (status == BatteryManager.BATTERY_STATUS_CHARGING) {
                    ...
                    || status == BatteryManager.BATTERY_STATUS_FULL) && charingStatus) {  //caoqiaofeng modify SFZT-148 20141106 (&& charingStatus)
