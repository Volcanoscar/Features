...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        public static boolean putStringForUser(ContentResolver resolver, String name, String value,
                int userHandle) {
            /* liuhao for setupwizard would change display-sleep time 20150915 begin*/
            if (SCREEN_OFF_TIMEOUT.equals(name) && "com.google.android.setupwizard".equals(resolver.getPackageName())) {
                return false;
            }
            /* liuhao for setupwizard would change display-sleep time 20150915 end*/
            if (MOVED_TO_SECURE.contains(name)) {
                Log.w(TAG, "Setting " + name + " has moved from android.provider.Settings.System"
        ...
        public static final String CHARGING_REMIND_STATUS = "charging_remind_status"; 
        public static final String LOW_POWER_REMIND_STATUS = "low_power_remind_status"; 
        public static final String NOTIFICATION_REMIND_STATUS = "notification_remind_status"; 
