...
# cqf add MTSFEFL-14 20150523
PRODUCT_PACKAGES += SmartGesture
...
#liuhao for LFZSBDZT-41 mt6755 fm 20151124
ifeq ($(strip $(MTK_FM_SUPPORT)), yes)
ifeq ($(strip $(MTK_FM55_SUPPORT)), yes)
  PRODUCT_PACKAGES += FMRadio
  PRODUCT_COPY_FILES += packages/apps/FMRadio/lib/libfmjni55.so:system/lib64/libfmjni55.so
else
  PRODUCT_PACKAGES += FmRadio
endif
endif
...
#liuhao added for LFZSBDZT-44 KK videoplayer 20151124
ifeq ($(strip $(MTK_KK_VIDEOPLAYER_SUPPORT)), yes)
    PRODUCT_PACKAGES += KKVideos 
endif

#liuhao added for LFZSBDZT-44 KK videoplayer 20151124
ifeq ($(strip $(MLT_COMPASS_SUPPORT)), yes)
    PRODUCT_PACKAGES += MiCompass 
endif