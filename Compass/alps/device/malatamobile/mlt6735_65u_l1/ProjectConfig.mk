...
# cqf modify LFZS-5 (cu_lte_hd720 ->hd720) 201505018
BOOT_LOGO = hd720
BUILD_CTS = yes
BUILD_KERNEL = yes
BUILD_LK = yes
...
CUSTOM_HAL_CAM_CAL = s5k3l2xxtrulyotp s5k3l2xxsunwinotp
CUSTOM_HAL_COMBO = mt6735
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = s5k3l2_mipi_raw s5k3l2sunwin_mipi_raw ov8858_mipi_raw ov8858sunwin_mipi_raw
CUSTOM_HAL_LENS = s5k3l2xxtrulyaf s5k3l2xxsunwinaf dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l2_mipi_raw s5k3l2sunwin_mipi_raw
CUSTOM_HAL_MAIN_LENS = s5k3l2xxtrulyaf s5k3l2xxsunwinaf
...
CUSTOM_HAL_SUB_IMGSENSOR = ov8858_mipi_raw ov8858sunwin_mipi_raw
...
CUSTOM_KERNEL_CAM_CAL = s5k3l2xxtrulyotp s5k3l2xxsunwinotp
...
CUSTOM_KERNEL_IMGSENSOR = s5k3l2_mipi_raw s5k3l2sunwin_mipi_raw ov8858_mipi_raw ov8858sunwin_mipi_raw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = s5k3l2xxtrulyaf s5k3l2xxsunwinaf dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = 
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l2_mipi_raw s5k3l2sunwin_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = s5k3l2xxtrulyaf s5k3l2xxsunwinaf
CUSTOM_KERNEL_RTC = rtc
CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_SSW = ssw_single_v2
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_SUB_BACKUP_LENS = 
CUSTOM_KERNEL_SUB_IMGSENSOR = ov8858_mipi_raw ov8858sunwin_mipi_raw
CUSTOM_KERNEL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_TOUCHPANEL = GT1XX
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
# cqf modify modify 20150512
CUSTOM_MODEM = mlt6735_65u_l_lwg_dsds
...
# chb modify MTSFEFL-71 20150519 
...
# aoran turn MTK_BT_BLE_MANAGER_SUPPORT  yes to no for L1.
...
# aoran modify MTK_DATA_TRANSFER_APP yes to no for L506_BD_ZT.
...
# wangmeng modify underline from no to yes 20150910
...
# cqf close LFZS-114 20150720
# aoran open MTK_MASS_STORAGE for L506_BD_ZT.
...
#CREATE_PROJECT_INFO=20150505161331

MTK_BUILD_VERNO = L1_0_XXX_1.0_0.4_26112015
MALATA_QUERY_INTERNAL_VERSION = L506_BD_ZT_MT6735_L1_V1.3
...
#zhaoxy add for smartcover LFZS-8 
MLT_HALL_SUPPORT = yes

# shuyong add app manager
MALATA_APP_MANAGER = yes

# shuyong add powersaving
MALATA_POWER_SAVING = no
...
#liuhao for compass 20151126
MLT_COMPASS_SUPPORT = yes