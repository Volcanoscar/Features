...
import com.android.systemui.statusbar.policy.GestureControllerImpl;
import com.android.systemui.statusbar.policy.GloveControllerImpl;
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    //caoqiaofeng add MTSFEFL-14 20150323 start 
    GestureControllerImpl mGestureController;
    GloveControllerImpl mGloveController;
    //caoqiaofeng add MTSFEFL-14 20150323 end
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        //caoqiaofeng add MTSFEFL-14 20150323 start 
        mGestureController = new GestureControllerImpl(mContext);
	 //mGloveController = new GloveControllerImpl(mContext);//yutianliang delete for VFOZ-57
        //caoqiaofeng add MTSFEFL-14 20150323 end
        ...
        /// M: Support Battery Percentage caoqiaofeng add MTSFEFL-111 LFZS-96  20150424
	 TextView mPercentage = (TextView) mStatusBarView.findViewById(R.id.percentage);
        mBatteryController.addLabelView(mPercentage);
        ...
        if (mQSPanel != null) {
            final QSTileHost qsh = new QSTileHost(mContext, this,
                    ...
                    //caoqiaofeng add MTSFEFL-14 20150323 start                    
                    mGestureController
                    //,mGloveController//yutianliang delete for VFOZ-57
                    //caoqiaofeng add MTSFEFL-14 20150323 end
            );
	...
	//chb add for factorytest:VFOZ-2 2015-7-27 begin
	IntentFilter factoryTestFilter = new IntentFilter();
        ...
        //chb add for factorytest:VFOZ-2 2015-7-27 end
        /// M: [SystemUI] Support Smartbook Feature. @{
        if (SIMHelper.isMtkSmartBookSupport()) {
