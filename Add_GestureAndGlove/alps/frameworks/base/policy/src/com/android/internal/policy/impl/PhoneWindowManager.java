...
public class PhoneWindowManager implements WindowManagerPolicy {
 ...
 private void startDefaultActivity(String packageName, String activityName) {	
	...
	///PSS : poweroffFactoryTest @{
		BroadcastReceiver mPoweroffFactoryTestReceiver = new BroadcastReceiver() {
			public void onReceive(Context context, Intent intent) {
			   // Log.v(TAG, "mIpoEventReceiver -- onReceive -- entry");
				String action = intent.getAction();
				if (action.equals(FACTORYTEST_NORMAL_POWERKEY_SHUTDOWN_ACTION)) {
					mIsFactoryTestShutDown = true;
				} else if (FACTORYTEST_NORMAL_POWERKEY_RENEW_ACTION.equals(action)) {
					mIsFactoryTestShutDown = false;
				}
			}
		};
	   ///@}
