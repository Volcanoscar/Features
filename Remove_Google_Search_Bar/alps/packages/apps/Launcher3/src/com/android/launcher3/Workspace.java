...
public class Workspace extends SmoothPagedView
	...
	//chb modify for S551_LA_UN 2015-4-9 begin	
	// modify for Wallpaper centered
        private void updateOffset(boolean force) {
		if (mWaitingForUpdate || force) {
			mWaitingForUpdate = false;
			LauncherLog.d(TAG, "updateOffset: mWallpaperOffset = "
	...
	//chb modify for S551_LA_UN 2015-4-9 end 
