...
public class FeatureOptionUtils {
    ...
    /*liuhao added for one click removal 20151130 begin*/
    public static final String MLT_ONE_CLICK_REMOVAL = "ro.mlt_one_click_removal";
    public static final boolean isOneClickRemovalSupport() {
        return SystemProperties.get(MLT_ONE_CLICK_REMOVAL).equals(SUPPORT_YES);
    }
    /*liuhao added for one click removal 20151130 end*/
}
