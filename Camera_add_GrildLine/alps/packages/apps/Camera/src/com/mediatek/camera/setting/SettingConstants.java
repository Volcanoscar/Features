...
public class SettingConstants {
    ...
    public static final int SETTING_COUNT = 65; // shutter+1 ;grid line +1 touch shot +1;shutter key +1

	//pss modify for MOPLUES-45 20151215 start
	public static final String KEY_SHUTTER_SOUND = "perf_shutter_sound_key"; 
	public static final int ROW_SETTING_SHUTTER_SOUND_KEY = 61;
	
	//pss modify for MOPLUES-45 20151215 end
	/*liuhao for POPLUSVNMS-73 grid line 20151222 begin*/
    public static final String KEY_GRID_LINE = "perf_grid_line_key";
    public static final int ROW_SETTING_GRID_LINE_KEY = 62;
	/*liuhao for POPLUSVNMS-73 grid line 20151222 end*/
	
	//pss add for POPLUSVNMS-72 20151225 start
	public static final String KEY_VOLUME = "pref_camera_volumn_key";
	public static final int ROW_SETTING_VOLUME_KEY = 64;
	//pss add for POPLUSVNMS-72 20151225 end
   ...
   // setting key
    ...
    public static final String KEY_TOUCH_SHOT = "pref_touch_shot_key";
    ...
    /*liuhao added for touch shot 20150107 begin*/
    public static final int ROW_SETTING_TOUCH_SHOT                = 63;
    /*liuhao added for touch shot 20150107 end*/
    ...
    static {
        ...
        /*liuhao added for touch shot 20150107 begin*/
        SETTING_TYPE[ROW_SETTING_TOUCH_SHOT]                = ONLY_IN_PEFERENCE;
        /*liuhao added for touch shot 20150107 end*/
        // setting only in parameters
		
        SETTING_TYPE[ROW_SETTING_HEARTBEAT_MONITOR]         = ONLY_IN_PARAMETER; //pss modify for MOPLUES-45 20151215
		SETTING_TYPE[ROW_SETTING_VOLUME_KEY]              = ONLY_IN_PEFERENCE;////pss add for POPLUSVNMS-72 20151225
        /*liuhao for POPLUSVNMS-73 grid line 20151222 begin*/
        SETTING_TYPE[ROW_SETTING_GRID_LINE_KEY]             = ONLY_IN_PARAMETER;
        /*liuhao for POPLUSVNMS-73 grid line 20151222 end*/
    ...
    static {
		...
		KEYS_FOR_SETTING[ROW_SETTING_SHUTTER_SOUND_KEY]     = KEY_SHUTTER_SOUND; //pss modify for MOPLUES-45 20151215
		KEYS_FOR_SETTING[ROW_SETTING_VOLUME_KEY]       = KEY_VOLUME;//pss add for POPLUSVNMS-72 20151225
        /*liuhao for POPLUSVNMS-73 grid line 20151222 begin*/
		KEYS_FOR_SETTING[ROW_SETTING_GRID_LINE_KEY]         = KEY_GRID_LINE;
        /*liuhao for POPLUSVNMS-73 grid line 20151222 end*/
        /*liuhao added for touch shot 20150107 begin*/
        KEYS_FOR_SETTING[ROW_SETTING_TOUCH_SHOT]            = KEY_TOUCH_SHOT;
        /*liuhao added for touch shot 20150107 end*/
    };
    ...
    public static final int[] SETTING_GROUP_CAMERA_FOR_TAB = new int[]{
        ...
        /*liuhao added for touch shot 20150107 begin*/
        ROW_SETTING_TOUCH_SHOT,//camera
        /*liuhao added for touch shot 20150107 end*/
        ROW_SETTING_ASD,//camera
        ROW_SETTING_DNG,//camera
		...
		ROW_SETTING_VOLUME_KEY,//pss add for POPLUSVNMS-72 20151225
		ROW_SETTING_SHUTTER_SOUND_KEY, // //pss modify for MOPLUES-45 20151215
    };
