...
public class SettingListLayout extends FrameLayout implements InLineSettingItem.Listener,
    ...
    private boolean isSwitchSettingItem(ListPreference pref) {
        return SettingConstants.KEY_RECORD_LOCATION.equals(pref.getKey())
                ...
                || SettingConstants.KEY_TOUCH_SHOT.equals(pref.getKey())
				...
				|| SettingConstants.KEY_SHUTTER_SOUND.equals(pref.getKey())// pss add for MOPLUES-45 20151215
				/*liuhao for POPLUSVNMS-73 grid line 20151222 begin*/
				|| SettingConstants.KEY_GRID_LINE.equals(pref.getKey())
