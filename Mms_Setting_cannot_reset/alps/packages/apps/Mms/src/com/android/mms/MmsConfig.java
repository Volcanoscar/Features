...
public class MmsConfig {
    ...
    public static IpConfig mIpConfig;
    ...
    //aoran modify for POPLUSVNMS-30 start
    ...
    //aoran modify for POPLUSVNMS-30 end
   ...
   /* private static void loadSimInfo(Context context) {
	...
	// Mobile data connectivity on roaming
    public static boolean isDataConnectivityRoamingSupported() {
        return mMmsFeatureManagerPlugin.isFeatureEnabled(IMmsFeatureManagerExt.ENABLED_MOBILE_DATA_CONNECTIVITY_ROAMING);
    }
    ...
    public static boolean isDeliveryReportInRoamingEnable() {
        return mMmsFeatureManagerPlugin.isFeatureEnabled(IMmsFeatureManagerExt.DELIVERY_REPORT_IN_ROAMING);
    }
