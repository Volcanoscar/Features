...
//aoran modify for POPLUSVNMS-30 end
    ...
    public void init(int subId, TimeConsumingPreferenceListener listener, boolean skipReading) {
        ...
        mListener = listener;
        mSubId = subId;
        //aoran modify for POPLUSVNMS-30 Line
        boolean enabled = sp.getBoolean(CELL_BROADCAST,false);
    ...
    private void getCBState() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                //mUiHandler.sendEmptyMessage(QUERY_CBSMS_ACTIVATION);//aoran modify for POPLUSVNMS-30 start
        ...
        if (!isSetSuccess) {
            ...
            new Thread(new Runnable() {
                public void run() {
                        ...
                        //aoran modify for POPLUSVNMS-30 start
                        editor.putBoolean(CELL_BROADCAST,state);
                        editor.apply();
                        //aoran modify for POPLUSVNMS-30 end
