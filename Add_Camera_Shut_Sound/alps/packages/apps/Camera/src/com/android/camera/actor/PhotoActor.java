...
public class PhotoActor extends CameraActor implements FocusManager.Listener,
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        case KeyEvent.KEYCODE_VOLUME_UP:
               ZoomManager zoomManager = mICameraAppUi.getZoomManager();
        
               String sVal = mCameraActivity.getISettingCtrl().getSettingValue(
                    SettingConstants.KEY_VOLUME);
               Log.i(TAG, "onKeyDown keyCode=" + keyCode + ", value=" + sVal);
               if(sVal.isEmpty()) 
                       return false;
               int value = Integer.valueOf(sVal);
               if(2 == value){                 //zoom
                       if(keyCode == KeyEvent.KEYCODE_VOLUME_DOWN)
                               zoomManager.zoomIn();
                       else
                               zoomManager.zoomOut();
               }else if(1 == value){   //shoot
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        ...
        case KeyEvent.KEYCODE_CAMERA:
            ...
            return true;
	//chb add for  VFOZBAUBQ-46 begin 2015-9-6
	case KeyEvent.KEYCODE_VOLUME_DOWN:                             
        case KeyEvent.KEYCODE_VOLUME_UP:
		return true;
	//chb add for VFOZBAUBQ-46 end 2015-9-6   
        default:
            break;
        }
