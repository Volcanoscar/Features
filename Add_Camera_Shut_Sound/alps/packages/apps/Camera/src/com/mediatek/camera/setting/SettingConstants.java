...
public class SettingConstants {
    ...
    public static final int SETTING_COUNT = 64;//laiyang modify old:63
    // setting key
    public static final String KEY_CAMERA_ID                 = "pref_camera_id_key";
    public static final String KEY_JPEG_QUALITY              = "pref_camera_jpegquality_key";
    // shuyong camera volume entries 20141009 begin
    public static final String KEY_VOLUME = "pref_camera_volumn_key";
    // shuyong camera volume entries 20141009 end
    public static final String KEY_SHUTTER_SOUND = "perf_shutter_sound_key"; // laiyang shutter sound 20151103
    ...
    // shuyong camera volume entries 20141009 begin
    public static final int ROW_SETTING_VOLUME_KEY = 62;
    // shuyong camera volume entries 20141009 end
    public static final int ROW_SETTING_SHUTTER_SOUND_KEY = 63;// laiyang shutter sound 20151103
    ...
    static {
        ...
        // shuyong camera volume entries 20141009 begin        
        SETTING_TYPE[ROW_SETTING_VOLUME_KEY]              = ONLY_IN_PEFERENCE;
        // shuyong camera volume entries 20141009 end
        SETTING_TYPE[ROW_SETTING_SHUTTER_SOUND_KEY]         = ONLY_IN_PEFERENCE; // laiyang shutter sound 20151103
    ...
    static {
        ...
        // shuyong camera volume entries 20141009 begin
        KEYS_FOR_SETTING[ROW_SETTING_VOLUME_KEY]       = KEY_VOLUME;
        // shuyong camera volume entries 20141009 end
        KEYS_FOR_SETTING[ROW_SETTING_SHUTTER_SOUND_KEY]     = KEY_SHUTTER_SOUND; // laiyang shutter sound 20151103
    };
    ...
    public static final int[] SETTING_GROUP_CAMERA_FOR_TAB = new int[]{
        ...
        // shuyong camera volume entries 20141009 begin
        ROW_SETTING_VOLUME_KEY,
        // shuyong camera volume entries 20141009 end
        ROW_SETTING_FACEBEAUTY_PROPERTIES,//camera:Cfb
        ROW_SETTING_SHUTTER_SOUND_KEY, // laiyang shutter sound 20151103
    };
    ...
    public static final int[] UN_SUPPORT_BY_FRONT_CAMERA = new int[] {
        ROW_SETTING_SLOW_MOTION,
        //ROW_SETTING_CONTINUOUS_NUM,//chb modify for VFOZBAUBQ-100 2015-9-25
        ROW_SETTING_SLOW_MOTION_VIDEO_QUALITY,
