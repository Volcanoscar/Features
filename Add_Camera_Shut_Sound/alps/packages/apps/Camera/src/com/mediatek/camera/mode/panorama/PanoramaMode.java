...
public class PanoramaMode extends CameraMode {
    ...
    private void onPictureTaken(byte[] jpegData) {
        ...
        mCurrentNum++;
        /*liuhao for LFZS-44 20150630 (2->1)*/
        if (mCurrentNum == 1/*2*/) {
    ...
    private void showGuideString(int step) {
        ...
        case GUIDE_MOVE:
            ...
            /*liuhao modified for LFZS-43 20150630 begin*/
            mICameraAppUi.showInfo(
                    mActivity.getString(guideId) + "\n"
                            + mActivity.getString(R.string.panorama_guide_capture),
                    SHOW_INFO_LENGTH_LONG);
            return; //break;
            /*liuhao modified for LFZS-43 20150630 end*/
