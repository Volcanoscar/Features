...
public class NavigationBarView extends LinearLayout {
    ...
    public View getHideNavigationBarButton() {
    	ImageView view = (ImageView)mCurrentView.findViewById(R.id.hide);
			view.setImageDrawable(mNavBarPlugin.getBackImage(view.getDrawable()));
			return view;
    }
    ...
    public View getHomeButton() {
    	ImageView view = (ImageView)mCurrentView.findViewById(R.id.home);
    ...
    private void getIcons(Resources res) {
      ...
      mBackLandIcon = mNavBarPlugin.getBackLandImage(res.getDrawable(R.drawable.ic_sysbar_back_land));
      mBackAltIcon = mNavBarPlugin.getBackImeImage(res.getDrawable(R.drawable.ic_sysbar_back_ime));
      mBackAltLandIcon = mNavBarPlugin.getBackImeImage(res.getDrawable(R.drawable.ic_sysbar_back_ime));
      mRecentIcon = mNavBarPlugin.getRecentImage(res.getDrawable(R.drawable.ic_sysbar_recent));
      mRecentLandIcon = mNavBarPlugin.getRecentLandImage(res.getDrawable(R.drawable.ic_sysbar_recent_land));
    }
