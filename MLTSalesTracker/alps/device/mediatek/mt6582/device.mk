...
#aoran 20150227 add
ifeq ($(strip $(MALATA_SALES_TRACKING)), yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.malata_sales_tracking=1
endif

#aoran 20150306 add 
  PRODUCT_COPY_FILES += vendor/malata/etc/settings-config.xml:system/etc/settings-config.xml
