...
public class EasProvision extends EasOperation {
    ...
    public final boolean provision() {
        ...
        PolicyServiceProxy.setAccountPolicy(mContext, accountId, mPolicy, null);//hgx modify for VFOZISCY-88 20151225
        ...
        /// M: Call the method setAccountPolicy after a given policy is "active".
//        PolicyServiceProxy.setAccountPolicy(mContext, accountId, mPolicy, null);//hgx delete for VFOZISCY-88 20151225
