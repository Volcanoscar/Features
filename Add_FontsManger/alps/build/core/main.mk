...
#yutianliang add for SFZZANPCLL-124 begin
ifeq (user, $(TARGET_BUILD_VARIANT))
    WITH_DEXPREOPT := true
endif
#yutianliang add for SFZZANPCLL-124 end
...
ifeq ($(strip $(LOVELYFONTS_SUPPORT)), yes)
  ADDITIONAL_BUILD_PROPERTIES += ro.lovelyfonts_support=1
#ADDITIONAL_BUILD_PROPERTIES += persist.sys.lovelyfonts.path=system/fonts/free/gyunzhongxi-v3.02-FB24819F2A7BF624111C18C0F5B9A874.ttf
endif
#=====================lovelyfonts end  =================================
