...
//========================lovelyfonts start========================
        if ("1".equals(SystemProperties.get("ro.lovelyfonts_support", "0"))) {
            if (emojiFont != delta.emojiFont) {
                emojiFont = delta.emojiFont;
                int config_font_type = 0x20000000;
                changed |= config_font_type;
                android.graphics.Typeface.updateEmojifonts();
            }
        }
//========================lovelyfonts end  ========================
...
//========================lovelyfonts start========================
        if ("1".equals(SystemProperties.get("ro.lovelyfonts_support", "0"))) {
            float a1 = this.emojiFont;
            float b1 = that.emojiFont;
            if (a1 < b1) return -1;
            if (a1 > b1) return 1;
        }
//========================lovelyfonts end========================
...
//========================lovelyfonts start========================
        if ("1".equals(SystemProperties.get("ro.lovelyfonts_support", "0"))) {
            result = 31 * result + Float.floatToIntBits(emojiFont);
        }
//========================lovelyfonts end========================
...
//========================lovelyfonts start========================
        if ("1".equals(SystemProperties.get("ro.lovelyfonts_support", "0"))) {
            if (base.emojiFont != change.emojiFont) {
                delta.emojiFont = change.emojiFont;
            }
        }
///========================lovelyfonts end========================
