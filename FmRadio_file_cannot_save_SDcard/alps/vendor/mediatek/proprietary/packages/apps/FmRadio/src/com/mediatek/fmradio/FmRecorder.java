...
public class FmRecorder implements MediaPlayer.OnCompletionListener,
    ...
    public void startRecording(Context context) {
        ...
        //String recordingSdcard = FmRadioUtils.getDefaultStoragePath();//old://yutianliang delete for SFZZANPCLL-40
        String recordingSdcard = StorageManagerEx.getDefaultPath();//yutianliang add for SFZZANPCLL-40
