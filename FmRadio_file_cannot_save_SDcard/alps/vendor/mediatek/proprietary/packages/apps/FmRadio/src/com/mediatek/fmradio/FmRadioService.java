...
//chb add 2015-4-10 begin
import android.content.ComponentName; //chb add 2015-4-10
import android.media.RemoteControlClient;
//chb add 2015-4-10 end

import com.mediatek.storage.StorageManagerEx;//yutianliang add for SFZZANPCLL-40
/**
...
public class FmRadioService extends Service implements FmRecorder.OnRecorderStateChangedListener {
	...
	private  ComponentName mMLTFmMediaButtonIntentReceiver;
    //chb add 2015-4-10 end 
    ...
    //private static String sRecordingSdcard = FmRadioUtils.getDefaultStoragePath();//old://yutianliang delete for SFZZANPCLL-40
    private static String sRecordingSdcard = StorageManagerEx.getDefaultPath();//yutianliang add for SFZZANPCLL-40
    ...
    private void startRecording() {
        ...
        //sRecordingSdcard = FmRadioUtils.getDefaultStoragePath();//old://yutianliang delete for SFZZANPCLL-40
        sRecordingSdcard = StorageManagerEx.getDefaultPath();//yutianliang add for SFZZANPCLL-40
    ...
    public void onCreate() {
		...
		//chb add 2015-4-10 begin 
		Log.d(TAG, "registerMediaButtonEventReceiver.mMLTFmMediaButtonIntentReceiver" );
        am = (AudioManager) getSystemService(Context.AUDIO_SERVICE);
        mMLTFmMediaButtonIntentReceiver = new ComponentName(getPackageName(),
                MLTFmMediaButtonIntentReceiver.class.getName());
        am.registerMediaButtonEventReceiver(mMLTFmMediaButtonIntentReceiver);
  
        Intent i = new Intent(Intent.ACTION_MEDIA_BUTTON);
        i.setComponent(mMLTFmMediaButtonIntentReceiver);
    ...
    public void onDestroy() {
        ...
        exitFm();
		//chb add 2015-4-10 begin
		Log.d(TAG, "unregisterMediaButtonEventReceiver.mMLTFmMediaButtonIntentReceiver" );
		if(mMLTFmMediaButtonIntentReceiver != null){
			am.unregisterMediaButtonEventReceiver(mMLTFmMediaButtonIntentReceiver);  
		}
