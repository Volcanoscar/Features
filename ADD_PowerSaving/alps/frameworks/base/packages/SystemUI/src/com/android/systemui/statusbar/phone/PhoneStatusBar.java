...
import com.android.systemui.statusbar.policy.PowersavingControllerImpl;
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    //caoqiaofeng add MTSFEFL-14 20150323 end
    /// shuyong 20150313 powersaving
    PowersavingControllerImpl mPowersavingController;
    ...
    protected PhoneStatusBarView makeStatusBarView() {
	 ...
	 mGloveController = new GloveControllerImpl(mContext);	
        //caoqiaofeng add MTSFEFL-14 20150323 end

        /// shuyong 20150313 powersaving
        mPowersavingController = new PowersavingControllerImpl(mContext);
	 ...
	 TextView mPercentage = (TextView) mStatusBarWindow.findViewById(R.id.percentage);
