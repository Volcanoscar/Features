...
public class FileViewActivity extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRootView = inflater.inflate(R.layout.mlt_file_manager_list, container, false);
        ...
        mAdapter = new FileListAdapter(mActivity, R.layout.mlt_file_browser_item, mFileNameList, mFileViewInteractionHub,
                mFileIconHelper);

        boolean baseSd = intent.getBooleanExtra(GlobalConsts.KEY_BASE_SD, !FileManagerPreferenceActivity.isReadRoot(mActivity));
