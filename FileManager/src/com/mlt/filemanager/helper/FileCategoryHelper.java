...
import com.mlt.filemanager.FilenameExtFilter;
import com.mlt.filemanager.MediaFile;
import com.mlt.filemanager.R;
import com.mlt.filemanager.MediaFile.MediaFileType;
import com.mlt.filemanager.R.string;
...
public class FileCategoryHelper {
    ...
    * @PackageName:com.mlt.filemanager.helper
    * @Function: 文件类型 枚举
    * @author:   chehongbin
    * @date:     2015-8-14 上午9:27:23  
    ...
    */
    public enum FileCategory {
        All, Music, Video, Picture, Theme, Apk, Zip, Doc, Custom, Other, Favorite
    }

    private static String APK_EXT = "apk";//apk 格式
    private static String THEME_EXT = "mtz";//自定义主题格式
    private static String[] ZIP_EXTS  = new String[] {"zip", "rar"};//压缩文件格式
    ...
    * @Description: 该Hash表存放 分类文件的名字 :<br><code> All, Music, Video, Picture, Theme, Apk, Zip, Doc, Custom, Other, Favorite</code>
    */
