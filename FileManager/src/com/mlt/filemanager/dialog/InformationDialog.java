...
package com.mlt.filemanager.dialog;
...
import com.mlt.filemanager.R.id;
import com.mlt.filemanager.R.layout;
...
public class InformationDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        mView = getLayoutInflater().inflate(R.layout.mlt_information_dialog, null);

        if (mFileInfo.IsDir) {
            setIcon(R.drawable.folder);
            asyncGetSize();
        } else {
            setIcon(R.drawable.fm_unknown);
        }
