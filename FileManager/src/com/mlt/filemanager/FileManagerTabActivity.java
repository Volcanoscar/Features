...
public class FileManagerTabActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        setContentView(R.layout.mlt_fragment_pager);
        mViewPager = (ViewPager) findViewById(R.id.pager);
        bar = getActionBar();
        bar.setNavigationMode(ActionBar.NAVIGATION_MODE_TABS); //设置actionbar的导航方式为Tab导航
        bar.setDisplayOptions(ActionBar.DISPLAY_SHOW_CUSTOM,ActionBar.DISPLAY_SHOW_CUSTOM | ActionBar.DISPLAY_SHOW_HOME
                        | ActionBar.DISPLAY_SHOW_TITLE);
        bar.setBackgroundDrawable(getResources().getDrawable(R.drawable.title_bar_bg));
        bar.setSplitBackgroundDrawable(getResources().getDrawable(
