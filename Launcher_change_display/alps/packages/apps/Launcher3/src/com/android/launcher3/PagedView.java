...
import android.view.animation.AccelerateDecelerateInterpolator;//tdj add
import android.view.animation.AccelerateInterpolator;//import for transition effect
...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    //tdj add for the transition effect start 20151208
    
    //define switch the launcher app list page's and workplace page's  transition effect
    ...
    //tdj add for the transition effect end 20151208
    ...
    //tdj add for transition start  20151208
    ...
    //tdj add for transition end  20151208
    ...
    **/
    ...
    //tdj add for launcher transition effect start 20151208
    ...
    */
    ...
    protected static abstract class TransitionEffect {
         ...
         public static final int RESULT_CODE = 6586;//mltm means malata_mobile
         
         public static final String[] EFFECT_ARRAY = {TRANSITION_EFFECT_NONE,TRANSITION_EFFECT_ZOOM_IN,TRANSITION_EFFECT_ZOOM_OUT,TRANSITION_EFFECT_ROTATE_UP,
                                                     TRANSITION_EFFECT_ROTATE_DOWN,TRANSITION_EFFECT_CUBE_IN,TRANSITION_EFFECT_CUBE_OUT,TRANSITION_EFFECT_STACK,
                                                     TRANSITION_EFFECT_ACCORDION,TRANSITION_EFFECT_FLIP,TRANSITION_EFFECT_CYLINDER_IN,TRANSITION_EFFECT_CYLINDER_OUT,
                                                     TRANSITION_EFFECT_CAROUSEL,TRANSITION_EFFECT_OVERVIEW};
    ...
    //tdj add for launcher transition effect end 20151208
}
