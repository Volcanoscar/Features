...
interface ILockSettings {
    ...
    void setVisitorModeLockPattern(in String pattern);
    boolean checkVisitorModePattern(in String pattern);
    void setVisitorModeLockPassword(in String password);
    boolean checkVisitorModePassword(in String password);
