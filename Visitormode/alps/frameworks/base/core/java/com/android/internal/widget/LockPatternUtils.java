...
public class LockPatternUtils {
    ...
    */
    ...
    public void setVisitorModeLockPattern(List<LockPatternView.Cell> pattern) {
        try {
            getLockSettings().setVisitorModeLockPattern(patternToString(pattern));
        } catch (RemoteException re) {
            Log.e(TAG, "Couldn't save visitor lock pattern " + re);
        }
    }
    
    public boolean checkVisitorModePattern(List<LockPatternView.Cell> pattern) {
        try {
            return getLockSettings().checkVisitorModePattern(patternToString(pattern));
        } catch (RemoteException re) {
            return true;
        }
    }
    
    public void setVisitorModeLockPassword(String password) {
        try {
            getLockSettings().setVisitorModeLockPassword(password);
        } catch (RemoteException re) {
            Log.e(TAG, "Couldn't save visitor lock password " + re);
        }
    }
    
    public boolean checkVisitorModePassword(String password) {
        try {
            return getLockSettings().checkVisitorModePassword(password);
        } catch (RemoteException re) {
            return true;
        }
    }
