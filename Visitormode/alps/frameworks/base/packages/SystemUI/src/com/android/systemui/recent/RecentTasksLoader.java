...
public class RecentTasksLoader implements View.OnTouchListener {
    ...
    static final boolean MltVisitorMode = FeatureOptionUtils.isMltVisitorModeSupport();
    ...
    public TaskDescription loadFirstTask() {
        ...
        if (recentTasks.size() > 0) {
            ...
            /*liuhao added for visitor mode 20141223 begin*/
            if (MltVisitorMode && isHideApp(intent.getComponent(), getHideAppInfoForDB())) {
                return null;
            }
            /*liuhao added for visitor mode 20141223 end*/
    ...
    public void loadTasksInBackground(final boolean zeroeth) {
        ...
        mTaskLoader = new AsyncTask<Void, ArrayList<TaskDescription>, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                /*liuhao added for visitor mode 20141223 begin*/
                List<HideAppInfo> hideList = getHideAppInfoForDB();
                /*liuhao added for visitor mode 20141223 end*/
                ...
                for (int i = first, index = 0; i < numTasks && (index < MAX_TASKS); ++i) {
                    ...
                    /*liuhao added for visitor mode 20141223 begin*/
                    if (MltVisitorMode && isHideApp(intent.getComponent(), hideList)) {
                        continue;
                    }
                    /*liuhao added for visitor mode 20141223 end*/
    ...
    private List<HideAppInfo> getHideAppInfoForDB() {
        ...
        boolean isInVisitorMode = Settings.Global.getInt(mContext.getContentResolver(),
    ...
    private boolean isHideApp(ComponentName component, List<HideAppInfo> hideAppList) {
        if (!MltVisitorMode) {
            return false;
        }
        ...
        for (HideAppInfo hide : hideAppList) {
            if (hide.mPkgName.equals(component.getPackageName())) {
                return true;
            }
        }
        return false;
