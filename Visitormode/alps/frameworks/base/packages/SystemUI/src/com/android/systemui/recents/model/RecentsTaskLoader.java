...
public class RecentsTaskLoader {
    ...
    public void preloadTasks(RecentsTaskLoadPlan plan, boolean isTopTaskHome) {
        ...
        if (visitorModeChange) {
            visitorModeChange = false;
            plan.mRawTasks = null;
        }
    ...
    /*liuhao added for visitor mode 20150403 begin*/
    private boolean visitorModeChange = false;

    public void setVisitorModeIsChange(boolean change) {
        visitorModeChange = FeatureOptionUtils.isMltVisitorModeSupport() ? false : change;
    }
    /*liuhao added for visitor mode 20150403 end*/
}
