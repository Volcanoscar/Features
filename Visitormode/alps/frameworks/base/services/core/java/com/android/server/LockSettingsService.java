...
public class LockSettingsService extends ILockSettings.Stub {
    ...
    @Override
    public void setVisitorModeLockPattern(String pattern) throws RemoteException {
        final byte[] hash = LockPatternUtils.patternToHash(
                LockPatternUtils.stringToPattern(pattern));
                
        mStorage.writeVisitorModePatternHash(hash);
    }
    
    @Override
    public boolean checkVisitorModePattern(String pattern) throws RemoteException {
        byte[] hash = LockPatternUtils.patternToHash(LockPatternUtils.stringToPattern(pattern));
        byte[] storedHash = mStorage.readVisitorModePatternHash();
    ...
    @Override
    public void setVisitorModeLockPassword(String password) throws RemoteException {
        mStorage.writeVisitorModePatternHash(mLockPatternUtils.passwordToHash(password, 0));
    }
    
    @Override
    public boolean checkVisitorModePassword(String password) throws RemoteException {
        byte[] hash = mLockPatternUtils.passwordToHash(password, 0);
        byte[] storedHash = mStorage.readVisitorModePasswordHash();
