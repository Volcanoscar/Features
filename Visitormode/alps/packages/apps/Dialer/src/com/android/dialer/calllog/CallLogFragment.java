...
public class CallLogFragment extends ListFragment
    ...
    public void onCreate(Bundle state) {
        ...
        /*liuhao modified for visitor mode 20141204 begin*/
        if (DialerUtils.isMltVisitorModeSupport()
        ...
        /*liuhao modified for visitor mode 20141204 end*/
    ...
    @Override
    public void onStart() {
        /*liuhao add for visitor mode 20141204 begin*/
        if (DialerUtils.isMltVisitorModeSupport()) {
            ...
            if (Settings.Global.getInt(getActivity().getContentResolver(),
                ...
                if (lv.getAdapter() == null) {
                    if (mHasFooterView && mFooterView != null) {
        ...
        /*liuhao add for visitor mode 20141204 end*/
