...
public class AlbumSetDataLoader {
    ...
    /*liuhao add for visitor mode 20141205 begin*/
    private Activity mActivity;
    private int mLastestMode = 0;
    private boolean mIsChange = false;
    /*liuhao add for visitor mode 20141205 end*/
    ...
    private class ReloadTask extends Thread {
        ...
        public void run() {
            ...
            while (mActive) {
                ...
                /* liuhao modified for visitor mode 20141205 begin */
                int currMode = 0;
                if (SystemProperties.get("ro.mlt.visitor_mode").equals("1")) {
                    currMode = Settings.Global.getInt(mActivity.getContentResolver(),
                            "malata_visitor_mode_in", 0);
                    if (mLastestMode != currMode) {
                        mIsChange = true;
                        mLastestMode = currMode;
                    }
                }
                /* liuhao modified for visitor mode 20141205 end */
                mDirty = false;
                updateLoading(true);
                ...
                if (info.version != version || mIsChange) { //liuhao modified for visitor mode
                ...
                /*liuhao added for visitor mode 20141205 begin*/
                if (currMode == 1) {
                    info.size = 0;
                }
                /*liuhao added for visitor mode 20141205 end*/
