...
public class MltVisitorModeLockGeneric extends PreferenceActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (getActivity() instanceof MltVisitorModeLockGeneric) {
            ...
            if (mPasswordConfirmed) {
                ...
                ChooseLockSettingsHelper helper = new ChooseLockSettingsHelper(this.getActivity(),
                        this);
        ...
        private void updatePreferencesOrFinish() {
            ...
            if (quality == -1) {
                ...
                addPreferencesFromResource(R.xml.malata_visitor_mode_settings_picker);
...
//                    MalataVisitorModeLockGeneric.InternalActivity.class);
//            //M: modify for voice unlock @{ 
...
//        }
        ...
        void updateUnlockMethodAndFinish(int quality, boolean disabled) {
            ...
            if (quality >= DevicePolicyManager.PASSWORD_QUALITY_NUMERIC) {
                ...
                Intent intent = new Intent().setClass(getActivity(), MltVisitorModeLockPassword.class);
                ...
                Intent intent = new Intent(getActivity(), MltVisitorModeLockPattern.class);
                intent.putExtra("key_lock_method", "pattern");
                intent.putExtra("pattern_mode", 0);
                intent.putExtra(CONFIRM_CREDENTIALS, false);
...
//                startActivity(intent);
        ...
        private Intent getVoiceSensorIntent() {
            Intent fallBackIntent = new Intent().setClass(getActivity(), MltVisitorModeLockGeneric.class);
            fallBackIntent.putExtra(LockPatternUtils.LOCKSCREEN_WEAK_FALLBACK, true);
