    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        public void onActivityResult(int requestCode, int resultCode, Intent data) {
            ...
            if (requestCode == CONFIRM_EXISTING_REQUEST && resultCode == Activity.RESULT_OK) {
            	...
            	/*liuhao add for visitor mode 20141201 begin*/
                if (FeatureOption.MLT_VISITOR_MODE
                        && Settings.Global.getInt(getContentResolver(), "malata_visitor_mode", 0) != mChooseLockSettingsHelper
                                .utils().getKeyguardStoredPasswordQuality()) {
                    Settings.Global.putInt(getContentResolver(), "malata_visitor_mode", 0);
                }
            	/*liuhao add for visitor mode 20141201 end*/
