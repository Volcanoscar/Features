 ...
 */
public class MltVisitorModeLockPattern extends PreferenceActivity {
    /**
    ...
    public static class ChooseLockPatternFragment extends Fragment
        ...
        private int mPatternMode = 0; // 0:Master  1:Visitor 
        ...
        protected enum Stage {
            ...
            Introduction(
                    R.string.malata_master_pattern_header,
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (!(getActivity() instanceof MltVisitorModeLockPattern)) {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            mPatternMode = getActivity().getIntent().getIntExtra("pattern_mode", 0);
        ...
        protected void updateStage(Stage stage) {
            ...
            if (stage == Stage.Introduction) {
                mHeaderText.setText(mPatternMode == 0 ? stage.headerMessage : R.string.malata_visitor_pattern_header);
