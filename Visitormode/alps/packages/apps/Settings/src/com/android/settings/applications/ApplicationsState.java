...
public class ApplicationsState {
    ...
    public class Session {
        ...
        void handleRebuildList() {
            ...
            /*liuhao added for visitor mode 20141224 begin*/
            List<HideAppInfo> hideAppList = getHideAppInfoForDB();
            /*liuhao added for visitor mode 20141224 end*/
            ...
            for (int i=0; i<apps.size(); i++) {
                ...
                /// @}
                /*liuhao added for visitor mode 20141224 begin*/
                if (FeatureOption.MLT_VISITOR_MODE && checkHideApp(info, hideAppList)) {
                    continue;
                }
                /*liuhao added for visitor mode 20141224 end*/
        ...
        private boolean checkHideApp(ApplicationInfo app, List<HideAppInfo> hideAppList) {
            if (FeatureOption.MLT_VISITOR_MODE) {
                return false;
            }
            ...
            ComponentName cn = intent.resolveActivity(mPm);
            for (HideAppInfo hide : hideAppList) {
                if (hide.mPkgName.equals(app.packageName)
                        && hide.mAtyName.equals(cn.getClassName())) {
