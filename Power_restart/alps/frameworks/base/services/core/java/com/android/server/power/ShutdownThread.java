...
public final class ShutdownThread extends Thread {
     ...
     * 3: bypass both
     * */
    private static int screen_turn_off_time = 5 * 1000;
    //after 5sec  the screen become OFF, you can change the time delay
    ...
    private static boolean mRebootFlg = false; //aoran add POPLUSVNMS-10 LINE.
    ...
    //aoran add POPLUSVNMS-10 begin
    public static void setRebootFlg(boolean flag){
        mRebootFlg = flag;
    }
    //aoran add POPLUSVNMS-10 end
    /**
    ...
    static void shutdownInner(final Context context, boolean confirm) {
        ...
        //aoran add POPLUSVNMS-10 start
        int mPowerOff_or_Reboot_title =  mRebootFlg ? (com.android.internal.R.string.zzz_reboot_title)
                                      : (mRebootSafeMode ? com.android.internal.R.string.reboot_safemode_title
                                      : com.android.internal.R.string.power_off);

        int mPowerOff_or_Reboot_message = mRebootFlg ? com.android.internal.R.string.zzz_reboot_message  : resourceId;
        //aoran add POPLUSVNMS-10 end
        if (confirm) {
...
//                  .setMessage(resourceId)
                    .setTitle(mPowerOff_or_Reboot_title)      //aoran add POPLUSVNMS-10 LINE
                    .setMessage(mPowerOff_or_Reboot_message)  //aoran add POPLUSVNMS-10 LINE
    ...
    public void running() {
        ...
        if (mShutdownFlow == IPO_SHUTDOWN_FLOW) {
            ...
            mContext.sendOrderedBroadcast(
                    (new Intent("android.intent.action.ACTION_SHUTDOWN_IPO")).
