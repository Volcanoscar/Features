...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private GlobalActionsDialog createDialog() {
        ...
        for (int i = 0; i < defaultActions.length; i++) {
            ...
            if (GLOBAL_ACTION_KEY_POWER.equals(actionKey)) {
                ...
                mItems.add(new RebootAction());//aoran add POPLUSVNMS-10 Linei.
    ...
    private final class PowerAction extends SinglePressAction implements LongPressAction {
        private PowerAction() {
            super(com.android.internal.R.drawable.ic_lock_power_off,
                ...
                com.android.internal.R.string.global_action_power_off);//aoran add POPLUSVNMS-10 Line.
        }

        @Override
        public boolean onLongPress() {
            mWindowManagerFuncs.setRebootFlg(false);   //aoran add POPLUSVNMS-10 Line.
        ...
        public void onPress() {
            ...
            mWindowManagerFuncs.setRebootFlg(false);   //aoran add POPLUSVNMS-10 Line.
            mWindowManagerFuncs.shutdown(true /*false*/ /* confirm */); //aoran modify false to true for S510L,Line.
        }
    }
    ...
    private final class RebootAction extends SinglePressAction implements LongPressAction {
        private RebootAction() {
            super(com.android.internal.R.drawable.zzz_ic_lock_reboot_system,
                //R.string.global_action_power_off);
                com.android.internal.R.string.zzz_reboot_title);//aoran add POPLUSVNMS-10 Line.
        }
        ...
        public void onPress() {
            // shutdown by making sure radio and power are handled accordingly.
            mWindowManagerFuncs.setRebootFlg(true);   //aoran add POPLUSVNMS-10 Line.
            mWindowManagerFuncs.reboot("click reboot");
        }
	}
    ...
    private void onAirplaneModeChanged() {
        ...
        //if (mHasTelephony) return; //chb modify for VFOZBAUBQ-144 at 20151021
